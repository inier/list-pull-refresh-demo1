// 装饰器集合
// 参考：https://github.com/Alfred-sg/mobx-demo/tree/master/src
// 参考：https://zhuanlan.zhihu.com/p/44127923
...
export function mixin(MixinCls) {
    ...
    return function(Cls) {
        ...
        mixinProperties.map((propertyName) => {
            if (!prototype[propertyName]) addHiddenProp(prototype, propertyName, mixinPrototype[propertyName]);
        });
